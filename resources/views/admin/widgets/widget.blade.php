                    ...
                    @if ($val['type'] == "text")
                        <div class="panel">
                             ...
                             <div class="panel-body" style="display: none;">
                                 <input type="text" class="form-control" id="{{ $key }}" name="{{ $key }}"
                                        placeholder="Title" @if(!empty($widget)) value="{{ $widget->title }}" @endif>
                             </div>
                         </div>
                     @elseif($val['type'] == "text_area")
                        <div class="panel">
                            ...
                            <div class="panel-body" style="display: none;">
                                <textarea class="form-control" name="{{ $key }}">@if(!empty($widget)){{ $widget->body }}@endif</textarea>
                            </div>
                        </div>
                        {{-- @elseif($val['type'] == "rich_text_box")
                            <div class="panel">
                                 ...
                                 <div class="panel-body">
                                     <textarea class="form-control {{ !isset($id) ?: 'richTextBox' }}" data-rich="richTextBox" name="{{ $key }}">@if(!empty($widget)){{ $widget->body }}@endif</textarea>
                                 </div>
                             </div> --}}
